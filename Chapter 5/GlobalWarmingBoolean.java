...
public class GlobalWarmingBoolean {
   ...
   public static void main(String[] args) {
	...
	boolean isAnswerA = answer.equalsIgnoreCase("a");
	boolean isAnswerB = answer.equalsIgnoreCase("b");
	boolean isAnswerC = answer.equalsIgnoreCase("c");
	boolean isAnswerD = answer.equalsIgnoreCase("d");
	boolean isOutOfScope = !isAnswerA || !isAnswerB || !isAnswerC || !isAnswerD;
