    ...
    public static void getMBTI() {
        ...
        switch (mbtiType) {
            case "INFP" -> System.out.println("""
                    INFP
                          Healer
                          The ThoughuserAnswersul Idealist (MBTI)
                          The Mediator (16Personalities)
                          
                          
                    The INFP Personality Type
                        INFPs are imaginative idealists, guided by thuserAnswersr own core values and beliefs.
                        ...
                        and meaning with thuserAnswersr own individual flair.
                        ...
                        INFPs believe that each person must find thuserAnswersr own path. They enjoy spending
                        time exploring thuserAnswersr own ideas and values, and are gently encouraging to others
                    ...
                    What does INFP stand for?
                        ...
                        for Introversion, iNtuition, Feeling, and PercuserAnswersving, which are four core
                        ...
                        rather than planned and organized (PercuserAnswersving).
            ...
            case "INTJ" -> System.out.println("""
                    ...
                    The INTJ Personality Type
                        ...
                        with thuserAnswersr innovative ideas. They have a talent for seuserAnsweruserAnswersg possibilities for
                        ...
                        typically focused inward, on thuserAnswersr own thoughuserAnswersul study of the world around
                        them. INTJs are drawn to logical systems and are much less comfortable with
                        the unpredictable nature of other people and thuserAnswersr emotions. They are typically
                        independent and selective about thuserAnswersr relationships, preferring to associate with
            ...
            case "INFJ" -> System.out.println("""
                    INFJ
                          Counselor
                          The InsighuserAnswersul Visionary (MBTI)
                          The Advocate (16Personalities)
                          
                          
                    The INFJ Personality Type
                        INFJs are thoughuserAnswersul nurturers with a strong sense of personal integrity and a
                        drive to help others realize thuserAnswersr potential. Creative and dedicated, they have
                        a talent for helping others with original solutions to thuserAnswersr personal challenges.
                        ...
                        himself. They trust thuserAnswersr insights about others and have strong faith in thuserAnswersr
            ...
            case "INTP" -> System.out.println("""
                    ...
                    The INTP Personality Type
                        ...
                        of thuserAnswersr time in thuserAnswersr own heads: exploring concepts, making connections, and
                    ...
                    What does INTP stand for?
                        ...
                        for Introverted, iNtuitive, Thinking, PercuserAnswersving, which are four core personality
                        traits based on the work of psychologist C.G. Jung.
                        ...
                        spontaneous and flexible rather than planned and organized (PercuserAnswersving).
            ...
            case "ENFP" -> System.out.println("""
                    ...
                    The ENFP Personality Type
                        ...
                        ENFPs love to help other people explore thuserAnswersr creative potential.
                                                                   
                        ENFPs are typically agile and expressive communicators, using thuserAnswersr wit, humor,
                    ...
                    What does ENFP stand for?
                        ...
                        stands for Extraversion, iNtuition, Feeling, and PercuserAnswersving, which are four
            ...
            case "ENTJ" -> System.out.println("""
                    ...
                    The ENTJ Personality Type
                        ...
                        to accomplish thuserAnswersr vision. They excel at logical reasoning and are usually
                        ...
                        charge; they see thuserAnswersr role as that of leader and manager, organizing people and
                        processes to achieve thuserAnswersr goals.
            ...
            case "ENTP" -> System.out.println("""
                    ...
                    The ENTP Personality Type
                        ...
                        thuserAnswersr quick wit and command of language to keep the upper hand with other people,
                        often cheerfully poking fun at thuserAnswersr habits and eccentricities. While the ENTP
                    ...
                    What does ENTP stand for?
                        ...
                        Thinking, PercuserAnswersving. ENTP indicates a person who is energized by time spent with
            ...
            case "ENFJ" -> System.out.println("""
                    ...
                    The ENFJ Personality Type
                        ENFJs are idealist organizers, driven to implement thuserAnswersr vision of what is best
                        for humanity. They often act as catalysts for human growth because of thuserAnswersr
                        ability to see potential in other people and thuserAnswersr charisma in persuading others
                        to thuserAnswersr ideas. They are focused on values and vision, and are passionate about
                        the possibilities for people.
                                
                        ENFJs are typically energetic and driven, and often have a lot on thuserAnswersr plates.
                        They are tuned into the needs of others and acutely aware of human suffering;
                        however, they also tend to be optimistic and forward-thinking, intuitively seuserAnsweruserAnswersg
                        opportunity for improvement. The ENFJ is ambitious, but thuserAnswersr ambition is not
            ...
            case "ISFJ" -> System.out.println("""
                    ...
                    The ISFJ Personality Type
                        ...
                        to others. They focus on fulfilling thuserAnswersr duties, particularly when they are taking
            ...
            case "ISFP" -> System.out.println("""
                    ...
                    The ISFP Personality Type
                        ISFPs are gentle caretakers who live in the present moment and enjoy thuserAnswersr surroundings
                        ...
                        ISFPs have a strong aesthetic sense and seek out beauty in thuserAnswersr surroundings. They are
                    ...
                    What does ISFP stand for?
                        ...
                        PercuserAnswersving. ISFP indicates a person who is energized by time spent alone
                        ...
                        to be spontaneous and flexible rather than planned and organized (PercuserAnswersving).
            ...
            case "ISTP" -> System.out.println("""
                    ...
                    The ISTP Personality Type
                        ...
                        troubleshooting. They approach thuserAnswersr environments with a flexible logic, looking for
                        ...
                        Because of thuserAnswersr astute sense of thuserAnswersr environment, they are good at moving quickly
                    ...
                    What does ISTP stand for?
                        ...
                        Katharine Briggs and Isabel Myers. It stands for Introverted, Sensing, Thinking,
                        PercuserAnswersving. ISTP indicates a person who is energized by time spent alone (Introverted),
                        who focuses on facts and details rather than ideas and concepts (Sensing), who makes
                        decisions based on logic and reason (Thinking) and who prefers to be spontaneous and
                        flexible rather than planned and organized (PercuserAnswersving).
            ...
            case "ESFJ" -> System.out.println("""
                    ...
                    The ESFJ Personality Type
                        ...
                        dedicated to thuserAnswersr responsibilities. They are highly attuned to thuserAnswersr emotional
                        ...
                        ESFJs value loyalty and tradition, and usually make thuserAnswersr family and friends thuserAnswersr
                        top priority. They are generous with thuserAnswersr time, effort, and emotions. They often
                        take on the concerns of others as if they were thuserAnswersr own, and will attempt to put
                        thuserAnswersr significant organizational talents to use to bring order to other people's
                        lives.
            ...
            case "ESFP" -> System.out.println("""
                    ...
                    What does ESFP stand for?
                        ...
                        Katharine Briggs and Isabel Myers. It stands for Extraverted, Sensing, Feeling,
                        PercuserAnswersving. ESFP indicates a person who is energized by time spent with others
                        (Extraverted), who focuses on facts and details rather than ideas and concepts
                        (Sensing), who makes decisions based on feelings and values (Feeling) and who prefers
                        to be spontaneous and flexible rather than planned and organized (PercuserAnswersving).
            ...
            case "ESTJ" -> System.out.println("""
                    ...
                    The ESTJ Personality Type
                        ...
                        ESTJs are the consummate organizers, and want to bring structure to thuserAnswersr surroundings.
            ...
            case "ESTP" -> System.out.println("""
                    ...
                    The ESTP Personality Type
                        ESTPs are energetic thrill-seekers who are at thuserAnswersr best when putting out fires,
                        whether literal or metaphorical. They bring a sense of dynamic energy to thuserAnswersr
                        ...
                        of humor. They use thuserAnswersr keen powers of observation to assess thuserAnswersr audience and
                    ...
                    What does ESTP stand for?
                        ...
                        Katharine Briggs and Isabel Myers. It stands for Extraverted, Sensing, Thinking,
                        PercuserAnswersving. ESTP indicates a person who is energized by time spent with others
                        (Extraverted), who focuses on facts and details rather than ideas and concepts
                        (Sensing), who makes decisions based on logic and reason (Thinking) and who prefers
                        to be spontaneous and flexible rather than planned and organized (PercuserAnswersving).
