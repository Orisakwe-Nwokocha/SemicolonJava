...
public class MBTI {
    ...
    private static int numberOfAs = 0;
    private static int numberOfBs = 0;
    ...
    public static void displayQuestions() {
        ...
        for (int index = 0; index < 20; index++) {
            System.out.println(MBTI.getMBTIQuestions(index));
    ...
    private static void processQuestionSet(ArrayList<String> personalityCategory, int index) {
        for (String answer : personalityCategory) {
            String[] splitQuestions = getMBTIQuestions(index).split("\t");

            if (answer.equals("A")) {
                System.out.println(splitQuestions[0]);
                numberOfAs++;
            }
            else {
                System.out.println(splitQuestions[splitQuestions.length - 1]);
                numberOfBs++;
            }
    ...
    private static void extrovertedVsIntroverted() {
        int index = 0;
        processQuestionSet(extrovertedIntroverted, index);

        System.out.println("Number of A selected: " + numberOfAs);
        System.out.println("Number of B selected: " + numberOfBs + "\n");

        if (numberOfAs > numberOfBs) mbti[0] = 'E';
        else mbti[0] = 'I';
    ...
    private static void sensingVsIntuitive() {
        int index = 1;
        processQuestionSet(sensingIntuitive, index);

        System.out.println("Number of A selected: " + numberOfAs);
        System.out.println("Number of B selected: " + numberOfBs + "\n");

        if (numberOfAs > numberOfBs) mbti[1] = 'S';
        else mbti[1] = 'N';
    ...
    private static void thinkingVsFeeling() {
        int index = 2;
        processQuestionSet(thinkingFeeling, index);

        System.out.println("Number of A selected: " + numberOfAs);
        System.out.println("Number of B selected: " + numberOfBs + "\n");

        if (numberOfAs > numberOfBs) mbti[2] = 'T';
        else mbti[2] = 'F';
    ...
    private static void judgingVsPerceptive() {
        int index = 3;
        processQuestionSet(judgingPerceptive, index);

        System.out.println("Number of A selected: " + numberOfAs);
        System.out.println("Number of B selected: " + numberOfBs + "\n");

        if (numberOfAs > numberOfBs) mbti[3] = 'J';
        else mbti[3] = 'P';
